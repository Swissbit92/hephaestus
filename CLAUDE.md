...
| Plugin | Scope |
|--------|-------|
| **crucible** | Generic, vendor-neutral craft tools: `cms`, `spar`, `grill-me`, `develop`, `start-branch`, `finish-branch`, `qa-gatekeeper`, `author-skill`, `eval-first`, `flag-gate`, `loop-harness`, `act-for-real`, `repo-audit` |
