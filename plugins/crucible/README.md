...
| **author-skill** | skill | Guide + scaffolder for writing a high-quality skill/plugin — the authoring patterns (with real exemplars) plus a pre-structured `SKILL.md` via the plugin's `scripts/new_skill.py`. |
